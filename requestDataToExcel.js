...
var clientInfoArray = [];
var startDate = "22/08/2017";
var endDate = "22/08/2017";
...
getGridData(function (reqData) {
  ...
  for(var i=0; i<documentIdArray.length; i++) {
    ...
    getDocumentById(documentIdArray[i]);
  }
  ...
  setTimeout(function() {
    ...
    for(var i=0; i<clientInfoArray.length; i++) {
      textToExcel += clientInfoArray[i].name + tab + clientInfoArray[i].contactNumber + tab + clientInfoArray[i].addressLine1 + clientInfoArray[i].addressLine2 + newLine;
    }
